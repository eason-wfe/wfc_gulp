...
<body class="body-wrapper">
	...
	<div class="main-wrapper">
		...
		<div class="container container-main container-col-2">
			<div class="row">
				<div class="hidden-xs hidden-sm col-md-4 col-lg-3 sticky-top">
					<?php include "html_model/article/art-aside.html";?>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
					<div class="layout-main">
						...
						<div class="mgz-visionbox  wow fadeInUp">
							<div class="mgz-cover">
								<img class="mgz-cover-img" src="img/magazine/cover/151.jpg">
								<img class="mgz-cover-img" src="img/magazine/cover/152.jpg">
								<img class="mgz-cover-img" src="img/magazine/cover/153.jpg">
								<img class="mgz-cover-img" src="img/magazine/cover/154.jpg">
								<img class="mgz-cover-img" src="img/magazine/cover/155.jpg">
								<img class="mgz-cover-img" src="img/magazine/cover/156.jpg">
								<!--
								[^ 註 ^]
								雜誌排列順序為舊 -> 新，
								新的在最下方
						...
						<div class="owl-carousel teamSlider wow fadeInUp">
							<div class="block">
								<div class="thumbnail thumbnailContent">
									<img src="img/magazine/page/01.jpg">
								</div>
							</div>
							<div class="block">
								<div class="thumbnail thumbnailContent">
									<img src="img/magazine/page/02.jpg">
								</div>
							</div>
							<div class="block">
								<div class="thumbnail thumbnailContent">
									<img src="img/magazine/page/03.jpg">
								</div>
							</div>
							<div class="block">
								<div class="thumbnail thumbnailContent">
									<img src="img/magazine/page/04.jpg">
								</div>
							</div>
							<div class="block">
								<div class="thumbnail thumbnailContent">
									<img src="img/magazine/page/05.jpg">
								</div>
							</div>
						</div>
					</div>
					<div class="layout-main">
						...
						<div class="layout-sharewidth item-3 item-re-lg-2 wow fadeInUp">
							<div class="layout-sharewidth-item">
								<img src="img/magazine/cover/156.jpg">
								<div class="mgz-unit">第 156 期</div>
							</div>
							<div class="layout-sharewidth-item">
								<img src="img/magazine/cover/155.jpg">
								<div class="mgz-unit">第 155 期</div>
							</div>
							<div class="layout-sharewidth-item">
								<img src="img/magazine/cover/154.jpg">
								<div class="mgz-unit">第 154 期</div>
							</div>
							<div class="layout-sharewidth-item">
								<img src="img/magazine/cover/153.jpg">
								<div class="mgz-unit">第 153 期</div>
							</div>
							<div class="layout-sharewidth-item">
								<img src="img/magazine/cover/152.jpg">
								<div class="mgz-unit">第 152 期</div>
							</div>
							<div class="layout-sharewidth-item">
								<img src="img/magazine/cover/151.jpg">
