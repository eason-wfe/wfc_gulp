		...
		<div class="container container-main container-col-2">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-9">
					<div class="layout-main layout-deco-title pb-0 mb-0">
					...
					<div class="wbox">
						...
						<div class="wbox-m">
							<div class="wbox-tbox">
								<img class="wbox-tmobi" src="img/warranty/t_mobi.jpg">
								<img class="wbox-tpc" src="img/warranty/t_pc.jpg">
								<div class="wbox-title">會員專屬保證制度</div>
								<img class="wbox-tpc is-t-right" src="img/warranty/t_pc.jpg">
							</div>
							<div class="layout-content mb-3 mt-3">
								歡迎您成為「World Family Club」寰宇家庭俱樂部的一員。在孩子美語學習的路途上，只要持續是俱樂部會員就能夠在有效會員期內，得到俱樂部的支持，享有此一專屬保固服務。
							</div>
							<ul class="layout-content">
								<li class="mb-2"><b>● 對象與版本：</b>
									<div class="layout-content ml-2">僅提供給俱樂部有效會員。非有效會員及積欠款項之客戶，將無法適用此一會員專屬保證制度。</div></li>
								<li class="mb-2">
									<b>● 保證範圍：</b>
								...
								<li class="mb-2"><b>● 申請方式：</b>
									<div class="layout-content ml-2">產品損壞更換細則及說明，請參閱WFC網站上最新更換維修表單。</div></li>
								<li class="mb-2"><b> ●郵資與費用 : </b>
									<div class="layout-content ml-2">因郵寄損壞產品所產生之費用，須由會員自行負擔。</div></li>
							</ul>
							<img src="img/warranty/wfc_g.jpg" class="wbox-wfc">
						</div>
