		...
		<div class="container container-main container-col-2">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-9">
					<!-- v UNIT STARTING v -->
					<div class="layout-main layout-deco-title pb-4">
						...
						<div class="profile">
							...
							<button type="button" class="btn layout-btn profile-btn">
								修改個人資料
							</button>
						</div>
						<ul class="linkBox share5 mt-5">
							<li><a href="#target1" class="link1">最新消息</a></li>
							<li><a href="#target2" class="link2">我的個人訊息</a></li>
							<li><a href="#target3" class="link3">我的最新留言通知</a></li>
							<li><a href="#target4" class="link4">我的文章</a></li>
							<li><a href="#target5" class="link5">我追蹤的文章</a></li>
						</ul>
					</div>
					<!-- v UNIT v -->
					<div id="target1" class="layout-main collapse-first">
						...
						<div class="layout-collapse-content">
							<div class="innerbox inner-1">
								...
								<div class="pagerArea text-center color-1">
					...
					<!-- v UNIT v -->
					<div id="target2" class="layout-main">
						...
						<div class="layout-collapse-content">
							<div class="innerbox inner-2">
								...
								<div class="pagerArea text-center color-2">
									<?php include "html_model/uikit/pager-item.html";?>
								</div>
							</div>
						</div>
					...
					<!-- v UNIT v -->
					<div id="target3" class="layout-main">
						...
						<div class="layout-collapse-content">
							<div class="innerbox inner-3">
								...
								<div class="pagerArea text-center color-3">
									<?php include "html_model/uikit/pager-item.html";?>
								</div>
							</div>
						</div>
					...
					<!-- v UNIT v -->
					<div id="target4" class="layout-main">
					...
					<!-- v UNIT v -->
					<div id="target5" class="layout-main">
						...
						<div class="profile is-setting">
							...
							<ul class="profile-box">
								<li class="profile-item">
									...
									<div class="profile-content"><input type="text" placeholder="請輸入新匿稱"></div>
								</li>
								<li class="profile-item">
									<div class="profile-title">修改密碼：</div>
									<div class="profile-content"><input type="password" placeholder="輸入新密碼"></div>
								</li>
								<li class="profile-item">
									<div class="profile-title">再次確認：</div>
									<div class="profile-content"><input type="password" placeholder="確認新密碼"></div>
								</li>
							</ul>
							<button type="button" class="btn layout-btn profile-btn is-giveup">
								放棄修改
							</button>
							<button type="button" class="btn layout-btn profile-btn">
								確定修改
							</button>
							<button type="button" class="btn layout-btn profile-btn is-pic">
								修改大頭照
							</button>
						</div>
					</div>
					...
					<div class="layout-main layout-deco-title">
						...
						<div class="post-contbox">
							今日台南、高雄、嘉義 「看！我是馬戲團小明星」、「馬戲團出遊趣」
							<img src="img/community/ad.jpg">
						</div>
