...
<head>
	...
	<link href="css/adviceCard_kr.css" rel="stylesheet" type="text/css">
</head>
					...
					<div class="layout-main">
						...
						<div class="sectionTitle text-center color-3 mt-0">
							<h2>
								...
								<span>WF Method Advice Card</span>
						...
						<div class="hight-light">
							<div class="height-light-box">
								...
								WF Method Advice Cards 는 회원님의 시작시기에 맞춰 DWE와 Club Service에 대한 활용법 안내 드리는 카드 발송 서비스입니다.<br/>
								구입 후, 2개월 / 7개월 / 12개월 차에 집으로 발송 됩니다.
						...
						<div class="ac">
							<div class="ac-item is-1st">
								...
								<img class="ac-img" src="img/parents/advice1.jpg">
							</div>
							<div class="ac-item is-2nd">
								...
								<img class="ac-img" src="img/parents/advice2.jpg">
							</div>
							<div class="ac-item is-3rd">
								...
								<img class="ac-img" src="img/parents/advice3.jpg">
							</div>
						</div>
