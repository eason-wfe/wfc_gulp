...
<head>
	...
	<link href="css/teLand_kr.css" rel="stylesheet" type="text/css">
</head>
		...
		<div class="container container-main container-col-2">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 sticky-top aside-lb">
					...
					<?php include "html_model/_fwe_kr/fwe-aside.html";?>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-9">
					<div class="layout-main">
						...
						<div class="layout-content">
							<div class="hight-light">
								<div class="height-light-box">
									<span class="first">“</span>
										Telephone English는 DWE의 노래 및 책 등을 기반으로 WF클럽 원어민과 함께
										주1회 레슨을 받는 무료 전화 서비스입니다.
							...
							<ul class="tree">
								<li class="tree-item is-left">
									<div class="tree-center">
										<img src="img/fwe/te1.jpg" class="tree-img">
								...
								<li class="tree-item is-right is-control">
									<div class="tree-center">
										<img src="img/fwe/te2.jpg" class="tree-img">
										<div class="tree-intro">
								...
								<li class="tree-item is-left is-control">
									<div class="tree-center">
										<img src="img/fwe/te3.jpg" class="tree-img">
										<div class="tree-intro">
											<div class="tree-cell">
												원어민과<br/>
												내가<br/>
							...
							<div class="hight-light">
								<div class="height-light-box have-zippy">
									<span class="first">“</span>
										<b>우리 아이가 어려서 아직 통화가 어려운가요? </b>
										전화를 걸지 않고, 언제 어디서든 원어민이 불러주는 노래를 들을 수 있는
										화상 비디오 서비스 ‘Face Call’이 있습니다.  (*모든 회원이 이용할 수 있는 인기 많은 서비스입니다.)			
									<span class="second">”</span>
									<img src="img/fwe/query.png">
								</div>
							</div>
						</div>
					</div>
