...
<head>
	...
	<link rel="stylesheet" href="css/notic_kr.css">
</head>
				...
				<div class="col-xs-12 col-xs-12 col-md-9">
					<div class="layout-main-card">
						...
						<div class="mypage-switchbox">
							<?php include "html_model/_comm_kr/comm-article-search.html";?>
						</div>
						<ul class="layout-card">
							<?php include "html_model/_comm_kr/notic-card-item.html"?>
						</ul>
						<div class="pagerArea text-center color-4">
							<?php include "html_model/uikit/pager-item.html";?>
						</div>
						<div class="cd-btnbox">
							<button type="button" class="btn layout-btn layout-btn-sm color-4">
								글쓰기
							</button>
