...
<head>
	...
	<link href="css/parentsGuide_kr.css" rel="stylesheet" type="text/css">
</head>
		...
		<div class="container container-main container-col-1">
			<div class="row">
				<div class="layout-col-12">
					<div class="layout-main">
						...
						<div class="sectionTitle text-center color-1 mt-0">
							<h2><!-- h2 only -->
								...
								<span>Froggy&Bunny Show</span>
								<span class="shape shape-right"></span>
							</h2>
						</div>
						<img class="layout-main-vision-img" src="img/event/1.jpg">
						<h3 class="layout-title-level-3 icon1">참가비용</h3>
						<div class="layout-content">
							방과후, 비키네 집에 모인 프로기, 버니가 무언가를 하고 있네요? 아~ 숫자 놀이를 즐기고 있군요. 비키, 조사야, 프로기 그리고 버니와 숫자를 세며 즐겁게 놀아 봐요. 오리, 개구리, 새, 구름, 벌, 징글 블록 그리고 더 많은 것들을 세어 볼 수 있어요!
						</div>
					...
					<button type="button" class="btn layout-btn btn-block layout-btn-lg color-1">
						Event apply
					</button>
				</div>
			</div>
