				...
				<div class="layout-col-12">
					...
					<div class="layout-main layout-box-shadow">
						<div class="act-layout">
							<div class="act-layout-left">
								...
								<div class="layout-content">
									<b>8664-020192-0000</b><br/>
									* 請於報名七日內(含假日)，以ATM轉帳完成繳款，若逾期未繳款者，系統將取消此筆報名資料。
								</div>
							</div>
							<div class="act-layout-right">
								...
								<div class="act-setbtns">
									<button type="button" class="btn layout-btn color-1">
										劃位 A 區
									</button>
									<button type="button" class="btn layout-btn color-1">
										劃位 B 區
									...
									<button type="button" class="btn layout-btn color-1 act-btn-reset">
										重選位置
									</button>
								</div>
								<div class="layout-content">
								...
								<div class="layout-content">
									...
									<div class="act-donebox">
										...
										<p class="act-donebox-p is-important">
											※ 請留意！收到APP
											<span class="act-donebox-p-dark">推播或簡訊</span>
								...
								<div class="layout-content">
									<div class="act-payment">
										<div class="act-payment-item">
											<div class="uikit-radio">
												<input type="radio" name="payment" class="uikit-radio-input" />
										...
										<div class="act-payment-item">
											...
											<b>戶名：</b>寰宇家庭股份有限公司，帳號：18552033<br />
											請註明會員編號、姓名、並備註『活動款』。
										</div>
									</div>
									<div class="act-payment">
										<b>請確認您的電子信箱：</b><br />
										確認報名成功後，我們將以電子郵件方式寄出活動預習單給您，謝謝！<br />
										您的電子信箱是：<input type="text" class="act-payment-input">
										<div class="uikit-checkbox">
											<input type="checkbox" class="uikit-checkbox-input">
					...
					<div class="layout-main layout-box-shadow layout-attention">
						...
						<div>
							...
							<div class="act-attention-content">
								<?php include "html_model/activity/act-attention2.html";?>
							</div>
						</div>
