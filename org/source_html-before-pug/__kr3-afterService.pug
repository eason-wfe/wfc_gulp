...
<head>
	...
	<link href="css/afterService_kr.css" rel="stylesheet" type="text/css">
</head>
		...
		<div class="container container-main container-col-2">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 sticky-top aside-lb">
					...
					<?php include "html_model/_parents_kr/parents-aside.html";?>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-9">
					<div class="layout-main">
						...
						<img class="is-pc" src="img/parents/as_vision.jpg">
						<img class="is-mobi" src="img/parents/as_vision_mobi.jpg">
						...
						<h3 class="layout-title-level-3 icon3">교체 품목 정보 :</h3>
						<?php include "html_model/_parents_kr/as-retable-item.html";?>
						<?php include "html_model/_parents_kr/as-retable-item.html";?>
						<?php include "html_model/_parents_kr/as-retable-item.html";?>
						<button type="button" class="btn layout-btn color-3">
							+ 추가하기
						</button>
					...
					<div class="layout-main is-narrow">
						...
						<div class="layout-collapse-content">
							<?php include "html_model/_parents_kr/as-attention.html";?>
						</div>
						<div class="rbox">
						...
						<div class="cbox">
							<img src="img/parents/as_m.png" class="cbox-title">
							본사 또는 이벤트 현장에서 교환 제품 접수는 불가합니다. 회원님의 회원 번호를 꼭 기입하여 아래 주소로 보내주세요
							<div class="cbox-bar">월드 패밀리 코리아 ㈜ 교환 보증 센터</div>
							서울 특별시 강남구 역삼로 25 길 35, 2 층 (역삼동, 케이 큐브 타워) 우트<br/>
							월드 패밀리 잉글리쉬 코리아 (주) 교환 보증 센터<br/>
							ㅂ다 반송시 발생되는 배송비는 고객 부담)
						</div>
					</div>
					<button type="button" class="btn layout-btn btn-block layout-btn-lg">
						신청하기
					</button>
					<hr>
					<hr>
					...
					<div class="layout-main">
						...
						<ul class="layout-card">
							<?php include "html_model/_mywfc_kr/as-card-item.html"?>
						</ul>
						<div class="numbox">
							이번에 <span>3</span> 번 제출
						</div>
					</div>
				</div>
			</div>
