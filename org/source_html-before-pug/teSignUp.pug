				...
				<div class="layout-col-12">
					<div class="layout-main">
						...
						<div class="layout-collapse-content">
							<?php include "html_model/te/te-attention.html";?>
						</div>
					</div>
					<div class="layout-main">
						...
						<div class="layout-content">
							<div class="uikit-radio signed">
								<input type="radio" name="child" class="uikit-radio-input" />
						...
						<div class="layout-content">
							<div class="uikit-radio">
								<input type="radio" name="time" class="uikit-radio-input" />
						...
						<div class="layout-content">
							<div class="uikit-radio">
									<input type="radio" name="tel" class="uikit-radio-input" />
						...
						<input type="text" class="te-tel-other-num" placeholder="其它電話">
					</div>
					<button type="button" class="btn layout-btn btn-block layout-btn-lg color-2 half-width-pc">
						下一步
					</button>
					<hr>
					<hr>
					...
					<div class="layout-main">
						...
						<div class="layout-content">
							<span class="te-name-ch">歐O小明</span>
							<span class="te-name-en">EnglishName</span>
						</div>
						<!-- LEVEL 2 -->
						<h3 class="layout-title-level-3 color-2">您選擇的課程</h3>
							<table class="table te-selected">
								...
								<tr class="te-selected-song">
										<td><div class="te-selected-icon"></div></td>
										<td>【歌曲練習】</td>
										<td>Baby's in the Bathtub</td>
										<td>PA1 #05</td>
										<td>
												<button type="button" class="btn btn-sm layout-btn">取消</button>
										</td>
									</tr>
					...
					<div class="layout-main">
						...
						.te-section-box-cap
						-->
							<div class="te-search"><input type="text" class="te-search-input" placeholder="關鍵字搜尋"></div>
							<table class="table te-section">
								...
								<tbody>
									...
									-->
										<td>
											<button type="button" class="btn btn-sm layout-btn">選取</button>
										</td>
