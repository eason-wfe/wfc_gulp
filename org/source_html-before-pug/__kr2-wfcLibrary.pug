...
<head>
	...
	<link href="css/wfcLibrary_kr.css" rel="stylesheet" type="text/css">
</head>
					...
					<div class="layout-main">
						...
						<div class="sectionTitle text-center color-2 mt-0">
							<h2>
								...
								<span>WFC Library</span>
								<span class="shape shape-right"></span>
							</h2>
						</div>
						<img src="img/fwe/library.jpg">
						...
						<div class="hight-light">
							<div class="height-light-box">
								<span class="first">“</span>
									각 어린이는 전용 수집 데이터베이스를 가지고 있습니다。 자녀의 이름을 먼저 선택하고 WF Club Library 를 입력하십시오。				
						...
						<div class="layout-content">
							귀하의 장치에 대한 링크를 클릭하여 WF Club Library APP를 다운로드하십시오 :
							<div class="wfcl-btn">
								<a href="" class="wfcl-link"><img src="img/fwe/btn_android.png"></a>
								<a href="" class="wfcl-link"><img src="img/fwe/btn_ios.png"></a>
							</div>
						</div>
						<hr>
						<hr>
						...
						<div class="hight-light">
							<div class="height-light-box">
								<span class="first">“</span>
									죄송합니다，회원 기간이이 서비스에 액세스하는 표준에 도달하지 않았습니다，사전에 비용을 지불하고 사전에이 서비스를 이용할 수도 있습니다。 자세한 정보는 온라인 고객 서비스에 문의하거나 고객 서비스 센터에 문의하십시오，가능한 한 빨리 질문에 답변 해 드리겠습니다。			
								<span class="second">”</span>	
							</div>
						</div>
					</div>
