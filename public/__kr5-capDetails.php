...
<html lang="ko">
  <head><?php include "html_model/head.html";?>
    ...
    <link href="css/capDetails_kr.css" rel="stylesheet">
  </head>
            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-truncate">
                  ...
                  <li class="breadcrumb-item">Cap application details</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-xs-12 col-md-9">
            <div class="layout-main-card"><?php include "html_model/uikit/aside-lb-open.html";?>
              <div class="sectionTitle text-center color-5 mt-0">
                <h2>
                  <!-- h2 only--><span class="shape shape-left"></span><span>Cap application details</span><span class="shape shape-right"></span>
                </h2>
              </div>
              <div class="mypage-switchbox">
                ...
                </div><a class="cd-history" data-toggle="modal" href="#cdModal">History</a>
              </div>
              <!--
              단내형 2018/10/24
              검토중
              ...
              -->
              <ul class="layout-card"><?php include "html_model/_mywfc_kr/cd-card-item.html";?></ul>
              <div class="pagerArea text-center color-5"><?php include "html_model/uikit/pager-item.html";?></div>
              <div class="cd-btnbox">
                <button class="btn layout-btn layout-btn-sm color-5" type="button">CAP 리포트 확인 »</button>
