            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-truncate">
                  ...
                  <li class="breadcrumb-item">1:1 Board</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-xs-12 col-md-9">
            <div class="layout-main-card"><?php include "html_model/uikit/aside-lb-open.html";?>
              <div class="sectionTitle text-center color-5 mt-0">
                <h2>
                  <!-- h2 only--><span class="shape shape-left"></span><span>1:1 Board</span><span class="shape shape-right"></span>
                </h2>
              </div>
              <div class="mypage-switchbox"><?php include "html_model/_mywfc_kr/mywfc-article-search.html";?></div>
              <ul class="layout-card"><?php include "html_model/_mywfc_kr/board-card-item.html";?></ul>
              <div class="pagerArea text-center color-5"><?php include "html_model/uikit/pager-item.html";?></div>
              <div class="cd-btnbox">
                <button class="btn layout-btn layout-btn-sm color-5" type="button">글쓰기</button>
            ...
            <div class="layout-main">
              ...
              <div class="post-btnbox">
                <button class="btn layout-btn layout-btn-sm is-left" type="button">목록</button>
                <button class="btn layout-btn layout-btn-sm is-right" type="button">저장하기</button>
              </div>
            </div>
            <hr>
            <hr>
            ...
            <div class="layout-main">
              ...
              <div class="post-titlebox">
                <p class="post-titlebox-p">영유아와 동행하여 DWE를 "재생"하는 방법 ?</p>
              </div>
              <ul class="post-contbox">
                <li class="post-contbox-item">
                  <div class="post-contbox-name is-color">Member : </div>
                  <div class="post-contbox-cont">클럽은 풍부한 학습 지원 서비스를 제공합니다.예를 들어, 미국 언어 활동, 전화 에세이 등은 아이들이 제품 컨텐츠를 쉽게 배울 수 있도록합니다.부모와 아빠는 자녀가 다시 재검토하는 것을 돕기 위해 "학습 지원 서비스"를 어떻게 사용합니까?</div>
                  <div class="post-contbox-time">2015-01-26 01:23</div>
                </li>
              </ul>
              <div class="post-btnbox">
                <button class="btn layout-btn layout-btn-sm is-left" type="button">목록</button>
                <button class="btn layout-btn layout-btn-sm is-right" type="button">삭제</button>
                <button class="btn layout-btn layout-btn-sm is-border is-right" type="button">수정</button>
              </div>
            </div>
            <hr>
            <hr>
            ...
            <div class="layout-main">
              ...
              <ul class="post-contbox">
                ...
                <li class="post-contbox-item">
                  ...
                  <div class="post-contbox-cont">네 확인되었습니다</div>
                  <div class="post-contbox-time">2015-01-26 01:23</div>
                </li>
              </ul>
              <div class="post-btnbox">
