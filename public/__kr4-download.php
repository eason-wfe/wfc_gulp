...
<html lang="ko">
  <head><?php include "html_model/head.html";?>
    ...
    <link href="css/download_kr.css" rel="stylesheet">
  </head>
            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-truncate">
                  ...
                  <li class="breadcrumb-item">온라인샵</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-xs-12 col-md-9">
            <div class="layout-main-card"><?php include "html_model/uikit/aside-lb-open.html";?>
              <div class="sectionTitle text-center color-4 mt-0">
                <h2>
                  <!-- h2 only--><span class="shape shape-left"></span><span>온라인샵</span><span class="shape shape-right"></span>
                </h2>
              </div>
            </div>
          </div>
