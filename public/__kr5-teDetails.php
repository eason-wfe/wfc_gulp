            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-truncate">
                  ...
                  <li class="breadcrumb-item">TE details</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-xs-12 col-md-9">
            <div class="layout-main-card"><?php include "html_model/uikit/aside-lb-open.html";?>
              <div class="sectionTitle text-center color-5 mt-0">
                <h2>
                  <!-- h2 only--><span class="shape shape-left"></span><span>TE details</span><span class="shape shape-right"></span>
                </h2>
              </div>
              ...
              <ul class="layout-card"><?php include "html_model/_mywfc_kr/td-card-item.html";?></ul>
              <div class="pagerArea text-center color-5"><?php include "html_model/uikit/pager-item.html";?>
