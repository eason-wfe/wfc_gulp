...
<html lang="ko">
  <head><?php include "html_model/head.html";?>
    ...
    <link type="text/css" href="css/wfcEvent_kr.css" rel="stylesheet">
  </head>
  <body class="body-wrapper">
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-truncate">
                  ...
                  <li class="breadcrumb-item">Event 소개</li>
                </ol>
              </nav>
            </div>
          </div>
      ...
      <div class="slider-outbox slider-show">
        <!--
        slider-show
        slider-activity
        slider-carnival
        slider-camp
        -->
        <div class="slider-d-top"></div>
        <div class="slider-d-left"></div>
        <div class="slider-d-right"></div>
        <div class="slick">
          <div class="vbox">
            <div class="vbox-in">
          ...
          <div class="row">
            <div class="layout-col-12">
              <div class="layout-main">
                <div class="etitle icon2">
                  <div class="etitle-icon"></div>
                  <div class="etitle-w">쇼</div>
                </div>
                ...
                <button class="btn layout-btn layout-btn-sm" type="button">More »</button>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="slider-outbox slider-activity">
        <div class="slider-d-top"></div>
        <div class="slider-d-left"></div>
        <div class="slider-d-right"></div>
        <div class="slick">
        ...
        <div class="container container-main container-col-1">
          <div class="row">
            <div class="layout-col-12">
              <div class="layout-main">
                <div class="etitle icon1">
                  <div class="etitle-icon"></div>
                  <div class="etitle-w">액티비티</div>
                </div>
                <div class="layout-content">방과후, 비키네 집에 모인 프로기, 버니가 무언가를 하고 있네요? 아~ 숫자 놀이를 즐기고 있군요. 비키, 조사야, 프로기 그리고 버니와 숫자를 세며 즐겁게 놀아 봐요. 오리, 개구리, 새, 구름, 벌, 징글 블록 그리고 더 많은 것들을 세어 볼 수 있어요!</div>
                <button class="btn layout-btn layout-btn-sm" type="button">More »</button>
              </div>
      ...
      <div class="slider-outbox slider-carnival">
        <div class="slider-d-top"></div>
        <div class="slider-d-left"></div>
        <div class="slider-d-right"></div>
        <div class="slick">
        ...
        <div class="container container-main container-col-1">
          <div class="row">
            <div class="layout-col-12">
              <div class="layout-main">
                <div class="etitle icon3">
                  <div class="etitle-icon"></div>
                  <div class="etitle-w">카니발</div>
                </div>
                <div class="layout-content">방과후, 비키네 집에 모인 프로기, 버니가 무언가를 하고 있네요? 아~ 숫자 놀이를 즐기고 있군요. 비키, 조사야, 프로기 그리고 버니와 숫자를 세며 즐겁게 놀아 봐요. 오리, 개구리, 새, 구름, 벌, 징글 블록 그리고 더 많은 것들을 세어 볼 수 있어요!</div>
                <button class="btn layout-btn layout-btn-sm" type="button">More »</button>
              </div>
      ...
      <div class="slider-outbox slider-camp">
        <div class="slider-d-top"></div>
        <div class="slider-d-left"></div>
        <div class="slider-d-right"></div>
        <div class="slick">
        ...
        <div class="container container-main container-col-1">
          <div class="row">
            <div class="layout-col-12">
              <div class="layout-main">
                <div class="etitle icon4">
                  <div class="etitle-icon"></div>
                  <div class="etitle-w">캠프</div>
                </div>
                <div class="layout-content">방과후, 비키네 집에 모인 프로기, 버니가 무언가를 하고 있네요? 아~ 숫자 놀이를 즐기고 있군요. 비키, 조사야, 프로기 그리고 버니와 숫자를 세며 즐겁게 놀아 봐요. 오리, 개구리, 새, 구름, 벌, 징글 블록 그리고 더 많은 것들을 세어 볼 수 있어요!</div>
                <button class="btn layout-btn layout-btn-sm" type="button">More »</button>
              </div>
