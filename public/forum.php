  ...
  <body class="body-wrapper">
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-truncate">
                  ...
                  <li class="breadcrumb-item">會員交流園地</li>
                </ol>
              </nav>
            </div>
          </div>
      ...
      <div class="container container-main container-col-2">
        <div class="row">
          <div class="col-md-4 col-lg-3 sticky-top forum-filsort-ui"><?php include "html_model/forum/forum-aside.html";?></div>
          <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
            <div class="layout-main layout-main-intro">
              <div class="sectionTitle text-center color-4 mt-0">
                <h2>
                  <!-- h2 only--><span class="shape shape-left"></span><span>會員交流園地</span><span class="shape shape-right"></span>
                </h2>
              </div>
              <div class="layout-content">「會員交流園地」是寰宇家庭俱樂部會員專屬的社群網站。<br>爸爸、媽媽可以透過發表或分享美語學習相關的各種訊息，如何使用寰宇家庭俱樂部的各種服務，使用DWE教材的經驗、煩惱、艱辛、快樂及美好的回憶，讓我們的美語學習的生活變得豐富有趣。<br>
              ...
              <div class="forum-fil-day-hot">
                <div class="forum-fil-day-hot-radio">
                  <div class="uikit-radio">
                    <input class="uikit-radio-input" type="radio" name="filter" checked="">
                    <label class="uikit-radio-label">日期排序</label>
                  </div>
                  <div class="uikit-radio">
                    <input class="uikit-radio-input" type="radio" name="filter">
                    <label class="uikit-radio-label">人氣排序</label>
                  </div>
                </div>
                <div class="forum-fil-day-hot-info">
                  <div class="forum-fil-day-hot-state">* 以下文章依<span class="forum-fil-day-hot-text">「親子學習計畫」</span>主題作分類，並依<span class="forum-fil-day-hot-text">「日期」</span>排序</div><a class="forum-filsort-open" href="">重新設定文章分類條件 »</a>
                </div>
              </div>
            </div>
            <!-- FULL-->
            ...
            <div class="layout-main layout-main-full layout-main-post mb-0" id="articleReport">
              ...
              <div class="layout-main-full-inbox">
                <div class="sectionTitle text-center color-4 mt-0">
                  <h2>
                    <!-- h2 only--><span class="shape shape-left"></span><span>發表新文章</span><span class="shape shape-right"></span>
                  </h2>
                </div>
                ...
                <div class="forum-group">
                  <label class="forum-label" for="">文章標題</label>
                  <input class="forum-control" type="text" placeholder="新文章標題">
                </div>
                <div class="forum-group">
                  <label class="forum-label" for="">文章內容</label>
                ...
                <div class="forum-submit"><a class="forum-submit-lightbox" href="#forum-modal" data-toggle="modal">※ 請務必閱讀發表文章/留言之注意事項</a>
                  <button class="btn layout-btn layout-btn-md btn-block color-4" type="submit">發表新文章</button>
                </div>
              </div>
            </div>
          </div>
