...
<head>
	...
	<link rel="stylesheet" href="css/eventDetails_kr.css">
</head>
					...
					<div class="container">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb text-truncate">
								...
								<li class="breadcrumb-item">
									Activity application details / 
									Show application details / 
									Carnival application details
								</li>
							</ol>
						</nav>
					</div>
					...
					<div class="layout-main-card">
						...
						<div class="sectionTitle text-center color-5 mt-0">
							<h2><!-- h2 only -->
								...
								<span>
									Activity application details 
									<!--Show application details / Carnival application details-->
								</span>
						...
						<ul class="layout-card">
							<?php include "html_model/_mywfc_kr/ed-carnival-card-item.html"?>
							<?php include "html_model/_mywfc_kr/ed-carnival-card-item.html"?>
						</ul>
