			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-9">
					<div class="layout-main layout-deco-title">
						...
						<h3 class="layout-title-level-3 color-5">1. 請選擇小朋友名字切換記錄</h3>
						...
						<h3 class="layout-title-level-3 color-5 mt-5">2. 點選名稱前往並展開單元</h3>
						<ul class="linkBox share4">
							<li><a href="#target1" class="link1">美語活動</a></li>
							<li><a href="#target2" class="link2">電話美語</a></li>
							<li><a href="#target3" class="link3">CAP 親子學習計畫</a></li>
							<li><a href="#target4" class="link5">Face Call 觀看記錄</a></li>
						</ul>
					</div>
					<!-- CARNIVAL HISTORY -->
					<div id="target1" class="layout-main-card collapse-first">
						<div class="layout-collapse color-1">
							<h3 class="layout-title-level-3">美語活動</h3>
							<div class="layout-collapse-arrow"> </div>
						</div>
						<div class="layout-collapse-content">
							<div class="layout-card has-cancel innerbox inner-1">
							<!--
							[^ 註 ^]
							class has-cancel，只在「能 cancel 活動」的單元才用
							-->
					...
					<!-- TE HISTORY -->
					<div id="target2" class="layout-main-card">
						<div class="layout-collapse color-2">
							<h3 class="layout-title-level-3">電話美語</h3>
							<div class="layout-collapse-arrow"> </div>
						</div>
						<div class="layout-collapse-content">
							<div class="layout-card has-cancel innerbox inner-2">
								<?php include "html_model/history/item-te.html";?>
							</div>
							<div class="pagerArea text-center color-5">
								<?php include "html_model/uikit/pager-item.html";?>
							</div>								
					...
					<!-- CAP HISTORY -->
					<div id="target3" class="layout-main-card">
						<div class="layout-collapse color-3">
							<h3 class="layout-title-level-3">CAP 親子學習計畫</h3>
							<div class="layout-collapse-arrow"> </div>
						</div>
						<div class="layout-collapse-content">
							<div class="layout-card innerbox inner-3">
					...
					<div id="target4" class="layout-main">
						<div class="layout-collapse color-5">
							<h3 class="layout-title-level-3">Face Call 觀看記錄</h3>
							<div class="layout-collapse-arrow"> </div>
						</div>
						<div class="layout-collapse-content pt-2">
							<ul class="fc-box mb-2 innerbox inner-5">
